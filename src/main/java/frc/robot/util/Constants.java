...
public final class Constants {
    ...
    public final class SwerveConstants {
        ...
        public static final IdleBehavior DISABLED_IDLE_BEHAVIOR = IdleBehavior.COAST; // Swerve Motor Idle Behavior when Disabled [COAST | BRAKE]
        public static final IdleBehavior ENABLED_IDLE_BEHAVIOR = IdleBehavior.BRAKE; // Swerve Motor Idle Behavior when Enabled [COAST | BRAKE]
    ...
    public final class IntakeConstants {
        ...
        public static final int TOP_ROLLER = 31; // CAN ID of the Top Roller of the Intake [CAN ID]
        public static final int BOTTOM_ROLLER = 32; // CAN ID of the Bottom Roller of the Intake [CAN ID]

        public static final boolean TOP_ROLLER_INVERTED = false; // Sets the Intake Top Roller to spin forward [True | False]
        public static final boolean BOTTOM_ROLLER_INVERTED = false; // Sets the Intake Bottom Roller to spin forward/backward [True | False]

        public static final IdleBehavior DISABLED_IDLE_BEHAVIOR = IdleBehavior.COAST; // Intake Motor Idle Behavior when Disabled [COAST | BRAKE]
        public static final IdleBehavior ENABLED_IDLE_BEHAVIOR = IdleBehavior.BRAKE; // Intake Motor Idle Behavior when Enabled [COAST | BRAKE]
        ...
        public static final double BOTTOM_ROLLER_REDUCTION = (1.0 / 2.89); // The gear reduction for bottom rollers [Roller Revolutions / Motor Revolution]

        public static final double TOP_ROLLER_DIAMETER = 2.0; // Sets the diameter of the Top Roller [in]
        public static final double BOTTOM_ROLLER_DIAMETER = 1.625; // Sets the diameter of the Bottom Roller [in]
        ...
        public static final double INTAKE_SPEED = 150.0; // Sets the Intake Speed [in / s]
        public static final double OUTAKE_SPEED = 0.0; // Sets the Outtake Speed [in / s]
    ...
    public final class IndexerConstants {
        ...
        public static final int FRONT_ROLLERS = 33; // CAN ID of the Indexer Front Rollers [CAN ID]
        public static final int BACK_ROLLERS = 34; // CAN ID of the Indexer Back Rollers [CAN ID]
        ...
        public static final boolean BACK_ROLLERS_INVERTED = false; // Makes the Indexer Back Rollers spin forward/backward [True | False]

        public static final IdleBehavior DISABLED_IDLE_BEHAVIOR = IdleBehavior.COAST; // Indexer Motor Idle Behavior when Disabled [COAST | BRAKE]
        public static final IdleBehavior ENABLED_IDLE_BEHAVIOR = IdleBehavior.BRAKE; // Indexer Motor Idle Behavior when Enabled [COAST | BRAKE]

        public static final double FRONT_ROLLERS_REDUCTION = 1.0; // Motor is directly on shaft so reduction is set [1]
        public static final double BACK_ROLLERS_REDUCTION = (1.0 / 2.89) * (16.0 / 30.0); // Back roller Reduction [Roller Revolutions / Motor Revolution]

        public static final double FRONT_ROLLERS_DIAMETER = 2.0; // Diameter of Front Rollers [in]
        public static final double BACK_ROLLERS_DIAMETER = 2.0; // Diameter of Back Rollers [in]

        public static final int START_BEAM = 9; // Number of port that the starting beam break is in [DIO Port]
        public static final int END_BEAM = 1; // Number of port that the end of the beam break is in [DIO Port]
        ...
        public static final double FRONT_INDEX_SPEED = 100.0; // Front Roller speed [in / s]
        public static final double BACK_INDEX_SPEED = 20.0; // Back Roller speed [in / s]
        public static final double FEED_SPEED = 100.0; // Feed Speed [in / s]
    ...
    public final class ArmConstants {
        ...
        public static final int PIVOT = 35; // Pivot Motor CAN ID [CAN ID]
        public static final boolean PIVOT_INVERTED = true; // Arm pivot forward/reverse

        public static final IdleBehavior DISABLED_IDLE_BEHAVIOR = IdleBehavior.COAST; // Arm Motor Idle Behavior when Disabled [COAST | BRAKE]
        public static final IdleBehavior ENABLED_IDLE_BEHAVIOR = IdleBehavior.BRAKE;  // Arm Motor Idle Behavior when Enabled [COAST | BRAKE]

        public static final int PIVOT_ENCODER = 2; // Pivot Ecoder [DIO Port]
        public static final double PIVOT_REDUCTION = (1.0 / 36.0) * (36.0 / 44.0) * (15.0 / 54.0); // Pivot Reduction [Roller Revolutions / Motor Revolution]
        ...
        public static final double PIVOT_P = 0.15; // Proportional Constant for the Arm [% / Degree]
        public static final double PIVOT_I = 0.15; // Integral Constant for the Arm [% / Degree * 20ms]
        public static final double PIVOT_IZ = 0.25; // Zone where the Integral activates [Degrees]
        public static final double PIVOT_D = 0.0075; // Derivative Constant for the Arm [% / Degree / 20ms]
    ...
    public final class ShooterConstants {
        ...
        public static final int TOP_ROLLERS = 36; // Shooter Top CAN ID [CAN ID]
        public static final int BOTTOM_ROLLERS = 37; // Shooter Bottom CAN ID [CAN ID]
        ...
        public static final IdleBehavior DISABLED_IDLE_BEHAVIOR = IdleBehavior.COAST; // Shooter Motor Idle Behavior when Disabled [COAST | COAST]
        public static final IdleBehavior ENABLED_IDLE_BEHAVIOR = IdleBehavior.COAST; // Shooter Motor Idle Behavior when Enabled [COAST | COAST]

        public static final double TOP_ROLLERS_REDUCTION = 1.0; // Top Rollers reduction [Roller Revolutions / Motor Revolution]
        public static final double BOTTOM_ROLLERS_REDUCTION = 1.0; // Bottom Rollers reductio [Roller Revolutions / Motor Revolution]

        public static final double TOP_ROLLERS_DIAMETER = 4.0; // Diameter of top rollers [in]
        public static final double BOTTOM_ROLLERS_DIAMETER = 4.0; // Diameter of bottom rollers [in]

        public static double SHOOT_SPEED = 600.0; // Speed of the shooter [in / s]
        public static double SHOOT_TOLERANCE = 25.0; // Uses the Bang Bang Controller to either set the motor power to 100 or kill it (must be coast) [in / s]
